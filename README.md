...
[![Version](https://img.shields.io/badge/Version-4.2.0-blue?style=flat-square)](https://github.com/zakky8/llm-jailbreak-taxonomy)
...
### Cross-model ASR (lower is better — single-seed point estimate, seed 42)
...
### Multi-seed bootstrap (10 seeds: 42–51 · 8,000 total trials · v4.1.0)
...
Full per-category bootstrap output: [`data/results/phase2b_bootstrap_ci.csv`](data/results/phase2b_bootstrap_ci.csv).
Generated by [`scripts/multi_seed.py --n-seeds 10`](scripts/multi_seed.py).
